...
import { ShoppingBag, Mail, Lock, User, AlertCircle, Check } from 'lucide-react';
        ...
        >
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center justify-center">
              <div className="flex items-center justify-center h-12 w-12 rounded-full bg-primary-500 text-white">
